  ...
  return (
    <>
      <div className="container flex justify-around items-start flex wrap mx-auto mt-8">
        {cartItems.length === 0 ? (
          <div className="text-4xl my-4 text-gray-600">
            Your cart is empty{" "}
            <Link to="/shop" className="hover:text-tblue">
              Go To Shop{" "}
            </Link>
            ...
            <div className="flex flex-col w-[80%] mt-4">
              ...
              <div className="mt-8 w-[40rem]">
                <div className="p-4 rounded-lg">
                  ...
                  <button
                    className="bg-black hover:bg-tblue text-white mt-4 py-2 px-4 rounded-full text-lg w-full"
