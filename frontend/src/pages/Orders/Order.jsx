...
const Order = () => {
  ...
  return isLoading ? (
    ...
    <div className="container flex flex-col ml-[4rem] mt-[2rem] md:flex-row">
      ...
      <div className="md:w-1/3">
        <div className="mt-5 border-gray-300 pb-4 mb-4">
          ...
          <p className="mb-4 mt-4">
            <strong className="text-gray-500">Order:</strong> {order._id}
          </p>
          ...
          <p className="mb-4">
            <strong className="text-gray-500">Email:</strong> {order.user.email}
          </p>
